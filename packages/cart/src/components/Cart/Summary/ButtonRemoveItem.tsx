    ...
    <>
      <LineItemRemoveLink>
        {({ handleRemove }) => {
          ...
          const ConfirmModal = ({ lineItemId }: any) => {
            return (
              <>
                {" "}
                {showModal ? (
...
export const NewButtonRemoveItem = ({
  cartItem,
  onDelete,
  showModal,
  onSetShowModel,
  ...
  const onSelectedDeleteButton = (lineItemId: any) => {
    onSetShowModel({
      value: lineItemId,
      isShowModal: true,
    })
  ...
  const onSelectDelete = (event: any) => {
    onDelete(showModal)
  ...
  return (
    <>
      <div>
        <div id={"delete" + lineItemId}>
          <a
            onClick={() => onSelectedDeleteButton(lineItemId)}
            className="cursor-pointer hover:text-red-500"
            title={title}
            data-test-id="button-remove-item"
          >
          ...
          {/* <ConfirmModal lineItemId={lineItemId} /> */}
        </div>
        <>
                  ...
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className="flex items-center justify-end p-2 border-t border-solid border-slate-200 rounded-b">
                      <button
                        className="text-red-500 background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"
                        onClick={(event) => onSelectDelete(event)}
                      >
                        Yes
                      </button>
                      <button
